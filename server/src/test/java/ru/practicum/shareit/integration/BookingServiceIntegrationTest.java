...
public class BookingServiceIntegrationTest {
    ...
    public void getByUserId() {
        ...
        var bookingFromGet = bookingService.getByUserId(booker.getId(), BookingState.valueOf("ALL"), 0, 10);
    ...
    public void getByItemsByUserId() {
        ...
        var bookingFromGet = bookingService.getByItemsByUserId(owner.getId(), BookingState.ALL.toString(), 0, 10);
