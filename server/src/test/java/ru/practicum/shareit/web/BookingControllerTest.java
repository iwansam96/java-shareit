...
public class BookingControllerTest {
    ...
    public void add() throws Exception {
        Mockito.when(bookingController.bookItem(bookingDtoInput, user2Id)).thenReturn(bookingDto);
    ...
    public void setApproveById() throws Exception {
        ...
        Mockito.when(bookingController.setApproveById(user1Id, bookingId, true)).thenReturn(bookingDto);
    ...
    public void getByUserId() throws Exception {
        ...
        Mockito.when(bookingController.getByUserId(user1Id, BookingState.ALL, 0, 10))
                .thenReturn(bookings);
    ...
    public void getByItemsByUserId() throws Exception {
        ...
        Mockito.when(bookingController.getByItemsByUserId(user1Id, BookingState.ALL.toString(), 0, 10))
                .thenReturn(bookings);
